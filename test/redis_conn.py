...
#         self.r=redis.Redis(host=self.redis_ip,port=6379,password='kes2719!')
        print self.redis_ip
        self.r=redis.Redis(host=self.redis_ip)
...
{'redis_key': '564d64b6-b072-fff2-05bf-02280b1de1a5::2019-05-10 16:35:20+00:00', 'redis_value': 1.0, 'redis_filed': 'cpu.usage.average'}""".splitlines()
    ...
    """
    r=Redis().r
    ret=r.hget("2019-05-15 20::564d2e7e-393a-b454-d7bd-a4688998dc92::Linux_Redhat7.2_60::net::usag","avg_count")
    print ret,ret==None
    if ret==None:
        r.hset("2019-05-15 20::564d2e7e-393a-b454-d7bd-a4688998dc92::Linux_Redhat7.2_60::net::usag","avg_count","1")
    ret=r.hget("2019-05-15 20::564d2e7e-393a-b454-d7bd-a4688998dc92::Linux_Redhat7.2_60::net::usag","avg_count")
    print ret
