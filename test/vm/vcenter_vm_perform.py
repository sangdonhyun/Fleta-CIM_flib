...
class Manager():
    ...
    def getTestHost(self):
        hostList=[]
        hostInfo={}
        hostInfo['name']='vcenter1'
        hostInfo['ip']='10.10.10.64'
        hostInfo['username']='administrator@vsphere.local'
        hostInfo['password']='Kes2719!'
        hostList.append(hostInfo)
        return hostList
    
    def main(self):
        print 'v-center vm perform'
        hostList=self.getTestHost()
