...
class VCenter():
    ...
    def getFileName(self):
        fn='%s_%s_1.tmp'%(self.vcInfo['name'],self.vcInfo['ip'])
    ...
    def getDataCenter(self,si):
            ...
            for dc in datacenters:
                ...
                for ds in datastores:
                    ...
                    print str(ds.info)
                    print '-' * 50
                    print 'ds.overallStatus :'
                    print str(ds.overallStatus)
                    print '-' * 50
                    print 'ds.summary :'
                    print str(ds.summary)
                    print '-' * 50
                    print 'ds.tag :'
                    print str(ds.tag)
                    print '-' * 50
                    ...
                    print str(ds.vm)
                    print '-' * 50
                    print 'ds.triggeredAlarmState :'
                    print str(ds.triggeredAlarmState)
                    print '-' * 50
                    print 'ds.value :'
                    print str(ds.value)
