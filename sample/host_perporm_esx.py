...
class perfdata():
   ...
   def run(self,content,vihost):
       ...
       try:
          ...
          """
          counter_name1 = 'cpu.usage.average'
          counter_name2 = 'mem.usage.average'
          counter_name3 = 'disk.usage.average'
          counter_name4 = 'net.usage.average'
          counterId = perf_dict[counter_name4]
